		...
		data() {
			return {
				formData: {
					...
					'avatar_file': {
						"extname": "png",
						"url": "https://vkceyugu.cdn.bspapp.com/VKCEYUGU-b7ef8d49-ed26-4d4e-ae01-df1eb1688fb0/445fc178-3529-4b37-b71e-6f028cc45610."
					}
				},
				rules,
				agree:false
		...
		methods: {
			...
			submit() {
				...
				if(!this.formData.nickname){
					this.formData.nickname = this.formData.username
				}
				uni.showLoading({
					mask: true
				})
