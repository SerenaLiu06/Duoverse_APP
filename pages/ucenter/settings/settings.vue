<template>
	<view class="content">
		...
		<!--	<uni-list-item v-if="userInfo.mobile" :title="$t('settings.changePassword')" :to="'/pages/ucenter/login-page/pwd-retrieve/pwd-retrieve?phoneNumber='+ userInfo.mobile" link="navigateTo"></uni-list-item> -->
			<uni-list-item title="关于" to="/pages/ucenter/about/about" link="navigateTo"></uni-list-item>
			<uni-list-item title="意见与反馈" to="/uni_modules/uni-feedback/pages/opendb-feedback/opendb-feedback" link="navigateTo"></uni-list-item>
		</uni-list>
		<uni-list class="mt10" :border="false">
		<!-- #ifndef H5 -->
			<!-- #ifdef APP-PLUS -->
